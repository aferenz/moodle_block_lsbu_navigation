YUI.add('moodle-block_lsbu_navigation-lsbu_navigation', function(Y){
...
TREE.prototype = {
    ...
    initializer : function(config) {
        ...
        } else if (window['lsbu_navtreeexpansions'+config.id]) {
            expansions = window['lsbu_navtreeexpansions'+config.id];
        }
        ...
        for (var i in expansions) {
            ...
            M.block_lsbu_navigation.expandablebranchcount++;
        }
...
BRANCH.prototype = {
    ...
    ajaxLoad : function(e) {
        ...
        Y.io(M.cfg.wwwroot+'/local/lsbu_api/ajax/getnavbranch.php', {
            method:'POST',
    ...
    ajaxProcessResponse : function(tid, outcome) {
        ...
        try {
            ...
            if (object.children && object.children.length > 0) {
                ...
                if (this.get('type') == 10 && coursecount >= M.block_lsbu_navigation.courselimit) {
    ...
    addChild : function(branchobj) {
        ...
        if (branch.draw(this.getChildrenUL())) {
            ...
            if (branch.get('type') == 10 && count >= M.block_lsbu_navigation.courselimit) {
...
Y.extend(BRANCH, Y.Base, BRANCH.prototype, {
    ...
    ATTRS : {
        ...
        id : {
            ...
            getter : function(val) {
                if (val == '') {
                    val = 'lsbu_expandable_branch_'+M.block_lsbu_navigation.expandablebranchcount;
                    M.block_lsbu_navigation.expandablebranchcount++;
                }
                return val;
            }
...
/**
 * This namespace will contain all of the contents of the LSBU navigation blocks
 * global navigation and settings.
 * @namespace
 */
M.block_lsbu_navigation = M.block_lsbu_navigation || {
