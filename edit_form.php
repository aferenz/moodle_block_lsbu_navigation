...
class block_lsbu_navigation_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $options = array(
            block_lsbu_navigation::TRIM_RIGHT => get_string('trimmoderight', $this->block->blockname),
            block_lsbu_navigation::TRIM_LEFT => get_string('trimmodeleft', $this->block->blockname),
            block_lsbu_navigation::TRIM_CENTER => get_string('trimmodecenter', $this->block->blockname)
        );
